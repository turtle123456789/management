        ...
        <div className='bg-gradient-to-bl from-blue-500 via-white via-50% to-blue-500  h-screen flex items-center justify-center' >
            ...
            <div>
                <div className='flex flex-col mb-1 items-center'>
                    ...
                    <h1 className="text-2xl font-bold leading-tight tracking-tight  md:text-4xl text-[#7195e5]">
                        MONEYVAY
                    </h1>
                </div>
                <form action="" className='bg-[#1f2937] p-6 rounded-lg' >
                    ...
                    <button type="submit" onClick={handleLogin} className="w-full mt-2 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Đăng nhập thanh toán</button>
                </form>
            </div>
        </div>
    )
